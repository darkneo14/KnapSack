...
<form action="" method="post" onsubmit=''>
  <center>
     ...
     <div id="example_5">
          ...
          <div id="example_74">
               <div id="example_75">Please Enter Your Printing Quantity and Time Estimated -
               </br>
</div>          
        <form action="projects1.php" method="post">
        <p>quantity: </p><input type="text"id="quantity" name="quantity">
        <p>time:</p> <input type="text" id="time" name="time">
        <input type="submit" formaction="projects1.php">
        </form>          
    <script>
	function func()
	{
