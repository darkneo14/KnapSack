...
<form action="" method="post" onsubmit=''>
  <center>
         <div id="example_1">
          <div id="example_9"><a href='home.php' target='_self' title='Ps Printing'><img id='img_9' src='images/example/example_9.png' width='370' height='138' border='0'  onmouseover="$(this).attr('src','images/example/logo-hover-image.png');" onmouseout="this.src='images/example/example_9.png';"/></a></div>
     ...
     <div id="example_5">
          ...
          <div id="example_74">
               <div id="example_75">
                 <h3>Much More Than Just Printers....</h3>
               </div>
               <div id="example_new">
                 <h3><em><strong>We&rsquo;re also proud to have an excellent team of in-house graphic designers who have expert knowledge in print, signage and vehicle livery which means we know how to design with the end product in mind – a unique skill that you don't have to go elsewhere for...</strong></em> </br>
               </br>
               PS Printing has a distinctly human approach to the printing business. We always figured that putting people before profits just made good commonsense. Our relationship with paper vendors allows us to provide an amazing collection of beautiful, earth-friendly papers from across North India. The local connections we've made in our community have helped us create a loyal following, as have our ability to keep promises and to consistently provide strikingly beautiful printing. None of this would be possible, of course, without the people who work here. We call each other "co-workers" and are always focused on hiring and nurturing great people to help us build our company
                 </h3>
               </div>
       </div>
     </div>
